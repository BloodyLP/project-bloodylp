...
const regularSeasonStats = [
    { icon: "🏒", label: "Spiele", value: "612" },
    { icon: "📈", label: "Punkte", value: "769" },
    { icon: "🟢", label: "Siege", value: "355" },
    { icon: "🔴", label: "Niederlagen", value: "257" },
    { icon: "🧮", label: "Siege %", value: "58,01%" },
    { icon: "🥅", label: "Tore", value: "1958" },
    { icon: "🚫", label: "Gegentore", value: "1670" },
];

const playoffStats = [
    { icon: "🏒", label: "Spiele", value: "136" },
    { icon: "🟢", label: "Siege", value: "92" },
    { icon: "🔴", label: "Niederlagen", value: "44" },
    { icon: "🧮", label: "Siege %", value: "67,65%" },
    { icon: "🥅", label: "Tore", value: "447" },
    { icon: "🚫", label: "Gegentore", value: "303" },
];
...
const regularSeasonRecords = [
    ...
    },
    {
        ...
        records: [
            ...
            {
                year: "2026",
                player: "AndreasKECBu / Phrasenschwein / Sackzefix",
                value: "jeweils 6",
            },
        ],
    },
    {
        ...
        records: [
            ...
            { year: "2024", player: "Schmiedli", value: "26" },
...
const playoffRecords = [
    ...
    },
    {
        ...
        records: [
            ...
            {
                year: "2020",
                player: "FabianHaken / Mäusefinger / SinusPerfan",
                value: "je 6",
            },
            { year: "2021", player: "Schmiedli", value: "14" },
            { year: "2022", player: "-", value: "-" },
